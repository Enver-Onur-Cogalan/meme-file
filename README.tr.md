...
[**Windows için indir**](https://github.com/Enver-Onur-Cogalan/meme-file/releases/latest) · [Test rehberi](docs/TEST-REHBERI.md) · [Proje planı](docs/PLAN.md) · [English](README.md)

</div>

<img src="docs/screenshots/tr/library.jpg" alt="Kütüphane ekranı: chip filtresi, fareyle önizleme" />
...
<table>
<tr>
<td width="50%"><img src="docs/screenshots/tr/player.jpg" alt="Oynatıcı" /></td>
<td width="50%"><img src="docs/screenshots/tr/chip-editor.jpg" alt="Chip düzenleyici" /></td>
</tr>
<tr>
...
<tr>
<td><img src="docs/screenshots/tr/inbox.jpg" alt="Gelen Kutusu" /></td>
<td><img src="docs/screenshots/tr/clip.jpg" alt="Klibi hazırla" /></td>
</tr>
<tr>
<td><b>Gelen Kutusu</b> · klasöre yeni düşen videolar sırayla gelir; 1-9 ile chip ver, Enter ile geç</td>
<td><b>Kırp / Discord'a sığdır / GIF</b> · tutamaçları sürüklerken önizleme o kareyi gösterir; hedef boyuta göre otomatik bit hızı; orijinal dosyaya dokunmaz</td>
</tr>
</table>

<img align="right" width="340" src="docs/screenshots/tr/quick-search.png" alt="Hızlı arama penceresi" />
...
- **Türkçe ve İngilizce arayüz** · sistem diline göre otomatik, Ayarlar'dan değiştirilebilir
...
| Arayüz | React 19, TypeScript, Tailwind CSS 4, Motion, Zustand, TanStack Virtual, Lucide · TR/EN |
...
- **Büyük kütüphaneler:** 5.000 videoda sorgular ~20 ms; 120 videodan sonra sanal liste devreye girer.
  İşlemci 4 kat yavaşlatılmışken bile tekerlekle kaydırmada kareler 18 ms'nin altında kalır.
- **Çok dilli:** Tek bir tip güvenli sözlük main ve renderer'da ortak; eksik çeviri derleme hatası verir,
  İngilizce çoğul biçimler sayı animasyonunu bozmadan seçilir.
